...
<body>
	...
	<br />
	<h3>Please Register or Update!! (This will overwrite the password if user exists)</h3>
	<form name="myform" method="post" onsubmit="return validate_form()" action="insert_validation_and_forward.jsp">
		<table>
			<tr>
				<td>Name:</td>
